...
//customerControler routing
router.post("/cust/getall",custController.getall)
router.post("/cust/getsingle",custController.getsingleData)
router.post("/cust/update",custController.updateData)
